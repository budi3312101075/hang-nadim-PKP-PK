...
const Login = () => {
  return (
    <div className="bg-primary w-screen h-screen flex py-3 lg:px-0 px-10">
      <div className="lg:w-1/2 w-full h-full py-16">
        <div className="flex flex-col bg-secondary max-h-max max-w-xl mx-auto rounded-xl px-7 h-full">
          <img
            src="./arff-logo.png"
            alt="logo"
            className="w-28 mx-auto mb-5 mt-10"
          />
